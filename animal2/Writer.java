...
public class Writer {
	 public static void writer(List<Animal> allAnimals) throws IOException {
		 try {
			 ...
			 File file = new File("C:\\Users\\User\\eclipse-workspace\\animal2\\src\\animal2\\output\\less_than_10.txt");// just object
			 PrintStream fw =  new PrintStream(file);
			 fw.print(lessThan10);
			 fw.flush();
			 fw.close();
			 
			 File file2 = new File("C:\\Users\\User\\eclipse-workspace\\animal2\\src\\animal2\\output\\between_11_and_40.txt");
			 PrintStream fw2 =  new PrintStream(file2);
			 fw2.println(between11and40);
			 fw2.flush();
			 fw2.close();
			 
			 File file3 = new File("C:\\Users\\User\\eclipse-workspace\\animal2\\src\\animal2\\output\\more_than_40.txt");
